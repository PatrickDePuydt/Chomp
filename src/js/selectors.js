...
const leftInstructions = document.querySelector(`[data-target='piece_directions'][data-family='x']`);
const rightInstructions = document.querySelector(`[data-target='piece_directions'][data-family='z']`);
